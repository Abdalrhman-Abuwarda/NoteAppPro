                    ...
                    return MainButton(
                      ...
                      function: () async {
                        if (formKye.currentState!.validate()) {
                          debugPrint("This is inSinUp Page");
                          auth.register(fullName: fullNameController.text, email: emailController.text, password: passwordController.text, gender: _human.toString());
